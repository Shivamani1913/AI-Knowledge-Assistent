        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatSessions_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SearchIndexKey = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrgDocumentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Chunks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Chunks_Documents_OrgDocumentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatSessions_ApplicationUserId",
                table: "ChatSessions",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Chunks_OrgDocumentId",
                table: "Chunks",
